...
import { ArrowLeft, Save, Sparkles, Utensils, CheckCircle2, Plus, Check } from "lucide-react";
...
export default function NewProductPage() {
  ...
  const [selectedPairings, setSelectedPairings] = useState<string[]>(["1", "3"]);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b pb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">
            Fill in the item details, pricing, category, and photo to publish to your QR menu
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="product-name"
                  placeholder="e.g. Double Truffle Smoked Burger"
                  value={name}
              ...
              <div className="space-y-2">
                ...
                <textarea
                  id="product-desc"
                  rows={4}
                  placeholder="Describe ingredients, allergy alerts, preparation details..."
                  value={description}
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-muted/30">
            <CardContent className="p-6 space-y-3">
              ...
              >
                {loading ? "Publishing..." : "Publish Product to Menu"}
              </Button>
